...
app.post("/api/files-db", requireAdmin, async (req, res) => {
  ...
  try {
    ...
    const safeFileName = original_name
...
const storageKey = `${section_id}/${Date.now()}_${safeFileName}`;
